// EN: src/app/services/_components/ImageWithListBlock.tsx
'use client';
...
export const ImageWithListBlock = ({ block }: { block: any }) => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16">
          ...
          <div className="md:col-span-2">
            <AnimateOnScroll delay={0.1}>
              <div className="prose prose-lg prose-invert prose-p:text-lg prose-p:leading-relaxed prose-p:text-white/70 prose-li:text-lg prose-li:text-white/70">
