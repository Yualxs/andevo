// EN: src/app/services/_components/ProcessBlock.tsx
'use client';
...
export const ProcessBlock = ({ block }: { block: any }) => {
  return (
    <section className="bg-white text-black relative z-50 rounded-t-[3rem] -mt-12 lg:rounded-t-[5rem] lg:-mt-20">
